...
- `cross-encoder/ms-marco-MiniLM-L6-v2`: Fast, general-purpose ranking model
- `cross-encoder/ms-marco-MiniLM-L12-v2`: Larger variant with better accuracy
- `cross-encoder/stsb-roberta-large`: Good for semantic similarity tasks
