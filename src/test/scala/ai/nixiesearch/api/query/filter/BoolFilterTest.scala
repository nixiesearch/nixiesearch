...
import ai.nixiesearch.config.FieldSchema.{FloatFieldSchema, IdFieldSchema, TextFieldSchema}
...
class BoolFilterTest extends SearchTest with Matchers {
  ...
  val docs = List(
    Document(List(IdField("_id", "1"), TextField("color", "red"), FloatField("price", 10))),
    Document(List(IdField("_id", "2"), TextField("color", "white"), FloatField("price", 20))),
    Document(List(IdField("_id", "3"), TextField("color", "red"), FloatField("price", 30))),
    Document(List(IdField("_id", "4"), TextField("color", "white"), FloatField("price", 40)))
  )
