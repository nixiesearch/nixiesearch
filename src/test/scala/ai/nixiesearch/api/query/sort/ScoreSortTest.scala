...
class ScoreSortTest extends SearchTest with Matchers {
  ...
  val docs = List(
    Document(List(IdField("_id", "miss"))),
    Document(List(IdField("_id", "0"), TextField("field", "In the town where I was born"))),
    Document(List(IdField("_id", "1"), TextField("field", "Lived a man who sailed to sea"))),
    Document(List(IdField("_id", "2"), TextField("field", "And he told us of his life"))),
    Document(List(IdField("_id", "3"), TextField("field", "In the land of submarines"))),
    Document(List(IdField("_id", "4"), TextField("field", "So we sailed on to the sun"))),
    Document(List(IdField("_id", "5"), TextField("field", "′Til we found a sea of green")))
  )
